...
// IIFE + CSS pair, vendored next to the xterm bundle
// (`assets/vendored/openkite-react-spike/`) so the Rust host can `include_str!`
// it with no manifest/hash parsing (same convention as tools/build-xterm).
//
...
export default defineConfig({
  ...
  build: {
    outDir: resolve(here, '../assets/vendored/openkite-react-spike'),
    emptyOutDir: true,
    target: 'es2022',
